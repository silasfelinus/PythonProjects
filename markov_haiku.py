...
def haiku_line(suffix_map_1, suffix_map_2, corpus, end_prev_line, target_syls):
	...
	if len(end_prev_line) == 0: # Build first line
		...
		while len(word_choices) == 0:
			...
			logging.debug("new randomj prefix = %s", prefix)
...
def main():
	"""Give user a choice of building a haiku or modifying an existing haiku"""
	intro = """\n
	A thousand monkeys at a thousand typerwriters...
